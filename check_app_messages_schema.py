...
try:
    ...
    with engine.connect() as conn:
        print("\n--- APP_MESSAGES TABLE SCHEMA ---")
        result = conn.execute(text("SELECT column_name, data_type, is_nullable FROM information_schema.columns WHERE table_name = 'app_messages'"))
